...
transm['SRC_Age_Category'] = "TBD"
transm.loc[((transm.SRC_AGE/365)<15),'SRC_Age_Category'] = "0-14"
transm.loc[((transm.SRC_AGE/365)>=15) & ((transm.SRC_AGE/365)<25),'SRC_Age_Category'] = "15-24"
transm.loc[((transm.SRC_AGE/365)>=25) & ((transm.SRC_AGE/365)<50),'SRC_Age_Category'] = "25-49"
transm.loc[ ((transm.SRC_AGE/365)>=50),'SRC_Age_Category'] = "50+"

transm['DEST_Age_Category'] = "TBD"
transm.loc[((transm.DEST_AGE/365)<15),'DEST_Age_Category'] = "0-14"
transm.loc[((transm.DEST_AGE/365)>=15) & ((transm.DEST_AGE/365)<25),'DEST_Age_Category'] = "15-24"
transm.loc[((transm.DEST_AGE/365)>=25) & ((transm.DEST_AGE/365)<50),'DEST_Age_Category'] = "25-49"
transm.loc[ ((transm.DEST_AGE/365)>=50),'DEST_Age_Category'] = "50+"

transm_M_to_F =  transm[(transm.SRC_GENDER == 0)]
transm_F_to_M =  transm[(transm.SRC_GENDER == 1)]
...
# Create a contingency table  of NODE_ID vs. SRC_Risk
pd.crosstab(transm_M_to_F.NODE_ID, transm_M_to_F.SRC_Risk).to_csv('M_to_F_NODE_ID_vs_SRC_Risk.csv', sep=',')

# Create a contingency table  of SRC_Risk vs. DEST_Risk
pd.crosstab(transm_M_to_F.SRC_Risk, transm_M_to_F.DEST_Risk).to_csv('M_to_F_SRC_Risk_vs_DEST_Risk.csv', sep=',')

# Create a contingency table  of DEST_Risk vs. NODE_ID
pd.crosstab(transm_M_to_F.DEST_Risk, transm_M_to_F.NODE_ID).to_csv('M_to_F_DEST_Risk_vs_NODE_ID.csv', sep=',')

# Create a contingency table  of SRC_Risk vs. SRC_Age_Category
pd.crosstab(transm_M_to_F.SRC_Risk, transm_M_to_F.SRC_Age_Category).to_csv('M_to_F_SRC_Risk_vs_SRC_Age.csv', sep=',')

# Create a contingency table  of DEST_Risk vs. DEST_Age_Category
pd.crosstab(transm_M_to_F.DEST_Risk, transm_M_to_F.DEST_Age_Category).to_csv('M_to_F_DEST_Risk_vs_DEST_Age.csv', sep=',')

# Create a contingency table  of SRC_Age_Category vs. DEST_Age_Category
pd.crosstab(transm_M_to_F.SRC_Age_Category, transm_M_to_F.DEST_Age_Category).to_csv('M_to_F_SRC_Age_vs_DEST_Age.csv', sep=',')
...
# Create a contingency table  of NODE_ID vs. SRC_Risk
pd.crosstab(transm_F_to_M.NODE_ID, transm_F_to_M.SRC_Risk).to_csv('F_to_M_NODE_ID_vs_SRC_Risk.csv', sep=',')

# Create a contingency table  of SRC_Risk vs. DEST_Risk
pd.crosstab(transm_F_to_M.SRC_Risk, transm_F_to_M.DEST_Risk).to_csv('F_to_M_SRC_Risk_vs_DEST_Risk.csv', sep=',')

# Create a contingency table  of DEST_Risk vs. NODE_ID
pd.crosstab(transm_F_to_M.DEST_Risk, transm_F_to_M.NODE_ID).to_csv('F_to_M_DEST_Risk_vs_NODE_ID.csv', sep=',')

# Create a contingency table  of SRC_Risk vs. SRC_Age_Category
pd.crosstab(transm_F_to_M.SRC_Risk, transm_F_to_M.SRC_Age_Category).to_csv('F_to_M_SRC_Risk_vs_SRC_Age.csv', sep=',')

# Create a contingency table  of DEST_Risk vs. DEST_Age_Category
pd.crosstab(transm_F_to_M.DEST_Risk, transm_F_to_M.DEST_Age_Category).to_csv('F_to_M_DEST_Risk_vs_DEST_Age.csv', sep=',')

# Create a contingency table  of SRC_Age_Category vs. DEST_Age_Category
pd.crosstab(transm_F_to_M.SRC_Age_Category, transm_F_to_M.DEST_Age_Category).to_csv('F_to_M_SRC_Age_vs_DEST_Age.csv', sep=',')
